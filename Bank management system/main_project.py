...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to My Personal Bank")
        p1 = PhotoImage(file='./images/bank1.png')
        window.iconphoto(True, p1)
        window.configure(background="#6D6BAC")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#AE5BA1", borderwidth="0", insertbackground="black",
                                 relief="ridge",
